...
const I18N = (() => {
  const STR = {
    zh: {
      ...
      bookTitle: '收藏册',
      bookDesc: '做过的菜都在这儿',
      bookDishes: '菜谱上的菜（{a}/{b}）',
      bookInvent: '你自己发明的（{n}）',
      bookEmpty: '还没有呢，去厨房做一个吧！',
      bookLocked: '还没做过',
      bookMine: '第{n}号发明',
      how1: '听听客人想吃什么',
      how2: '开车去把新鲜食材摘回来',
    ...
    en: {
      ...
      sortLeft: '{n} to go',
      sortWin: 'All sorted!',
      countTitle: 'Count them up',
      countDesc: 'Tap the right number',
      countAsk: 'How many {ing} are there?',
      countOops: 'Have another count?',
      countLeft: '{n} to go',
      countWin: 'You counted them all!',
      dressTitle: 'Give Gulu a new look',
      dressTap: 'Tap to dress me',
      dressFur: 'Fur colour',
      dressTrim: 'Apron and antennae',
      dressDone: 'Looking good!',
      bookTitle: 'Collection',
      bookDesc: 'Everything you have cooked',
      bookDishes: 'Recipe dishes ({a}/{b})',
      bookInvent: 'Your own inventions ({n})',
      bookEmpty: 'Nothing yet — go cook something!',
      bookLocked: 'Not cooked yet',
      bookMine: 'Invention no.{n}',
